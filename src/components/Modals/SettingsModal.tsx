...
const SettingsListItem: React.FC<SettingsListItemProps> = ({
  ...
  return (
    <li
      className="relative h-8 py-1.5 pl-2 flex select-none text-label-2 cursor-pointer 
    dark:text-dark-label-2 hover:bg-dark-fill-3 rounded-lg"
    >
      <div
        className={`h-5 flex flex-1 items-center pr-2 ${
